...
const STRINGS = {
  en: {
    ...
    passwordIntro:
      "Nexy has a few teacher-only screens where you can delete posts or accounts you don't want your students to see. They're locked so a curious student can't get in.",
    passwordGeneratedLabel: "We've picked a password for you:",
    passwordHelper:
      'Write it down, or click Copy and paste it somewhere safe. You can change it later in Settings.',
    ...
    doneSkipHint: "Want to add AI content creation later? It's in Settings, in the menu at the top.",
  ...
  pt: {
    ...
    passwordIntro:
      'A Nexy tem alguns ecrãs só para professores, onde podes apagar publicações ou contas que não queres que os teus alunos vejam. Estão trancados para que nenhum aluno curioso lá entre.',
    passwordGeneratedLabel: 'Escolhemos uma palavra-passe para ti:',
    passwordHelper:
      'Aponta-a, ou clica em Copiar e cola-a num sítio seguro. Podes alterá-la mais tarde nas Definições.',
    ...
    doneSkipHint: 'Queres adicionar a criação de conteúdo por IA mais tarde? Está nas Definições, no menu do topo.',
